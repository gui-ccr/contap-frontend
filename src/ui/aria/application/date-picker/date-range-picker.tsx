        ...
        <AriaDateRangePicker aria-label="Date range picker" shouldCloseOnSelect={false} {...props} value={value} onChange={setValue}>
            <AriaGroup>
                <Button size={size} color="secondary" iconLeading={CalendarIcon}>
                    {!value ? <span className="text-on-surface-variant/50">Select dates</span> : `${formattedStartDate} – ${formattedEndDate}`}
                </Button>
            </AriaGroup>
            <AriaPopover
            ...
            >
                <AriaDialog aria-label="Date range picker" className="flex rounded-2xl bg-surface-container-high shadow-xl ring-1 ring-outline-variant/30 text-on-surface focus:outline-hidden">
                    {({ close }) => (
                        <>
                            <div className="hidden w-38 flex-col gap-0.5 border-r border-solid border-outline-variant/30 p-3 lg:flex">
                            ...
                            <div className="flex flex-col">
                                ...
                                />
                                <div className="flex justify-between gap-3 border-t border-outline-variant/30 p-4">
