        ...
        <AriaCalendarCell
            ...
            className={({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, isOutsideMonth }) => {
                ...
                return cx(
                    ...
                    isInRange && isDisabled && "bg-surface-container-highest",
                    isSelected && isRangeCalendar && "bg-surface-container-highest",
                    ...
                    isLastDayOfMonth &&
                        ...
                        isBeforeEnd &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:translate-x-full after:bg-gradient-to-l after:from-transparent after:to-surface-container-highest in-[[role=gridcell]:last-child]:after:hidden",
                    ...
                    isFirstDayOfMonth &&
                        ...
                        isAfterStart &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:-translate-x-full after:bg-gradient-to-r after:from-transparent after:to-surface-container-highest in-[[role=gridcell]:first-child]:after:hidden",
                );
            }}
        >
            {({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, formattedDate }) => {
                ...
                return (
                    <div
                        className={cx(
                            "relative flex size-full items-center justify-center rounded-full text-sm text-on-surface hover:text-on-surface-variant",
                            // Disabled state.
                            isDisabled && "text-on-surface/50",
                            // Focus ring, visible while the cell has keyboard focus.
                            isFocusVisible ? "outline-2 outline-offset-2 outline-focus-ring" : "",
                            // Hover state for cells in the middle of the range.
                            isSelected && !isDisabled && isRangeCalendar ? "font-medium" : "",
                            markedAsSelected && "bg-primary font-medium text-on-primary",
                            // Hover state for non-selected cells.
                            !isSelected && !isDisabled ? "hover:bg-surface-bright hover:font-medium!" : "",
                            !isSelected && isTodayDate ? "bg-surface-container-highest font-medium text-primary" : "",
                        )}
                    >
                        {formattedDate}
                        ...
                        {(isHighlighted || isTodayDate) && (
                            <div
                                className={cx(
                                    ...
                                    markedAsSelected ? "bg-on-primary" : "bg-primary",
