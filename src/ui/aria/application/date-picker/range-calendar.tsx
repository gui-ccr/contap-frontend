...
import type { ButtonProps } from "@/ui/aria/base/buttons/button";
import { Button } from "@/ui/aria/base/buttons/button";
import { InputDateBase } from "@/ui/aria/base/input/input-date";
    ...
    return (
        <button
            ...
            className={cx(
                ...
                isSelected ? "bg-surface-container-highest text-on-surface hover:bg-surface-container-high" : "text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface",
                className,
            )}
        >
            {children}
            ...
            >
                <div className="flex flex-col gap-3 px-6 py-5 md:gap-2">
                    <header className={cx("relative flex items-center", visibleDurationMonths > 1 ? "justify-start" : "justify-between")}>
                        ...
                        <h2 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm font-semibold text-on-surface">
                    ...
                    {!isDesktop && (
                        <div className="flex items-center gap-2 md:hidden">
                            ...
                            <div className="text-md text-on-surface-variant">–</div>
                        ...
                        <AriaCalendarGridHeader>
                            {(day) => (
                                <AriaCalendarHeaderCell className="border-b-4 border-transparent p-0">
                                    <div className="flex size-10 items-center justify-center text-sm font-medium text-on-surface-variant">{day.slice(0, 2)}</div>
                ...
                {visibleDurationMonths > 1 && (
                    <div className="flex flex-col gap-3 border-l border-outline-variant/30 px-6 py-5">
