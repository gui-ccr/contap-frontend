...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                "bg-primary text-on-primary shadow-sm hover:opacity-90 data-loading:opacity-90",
                "ring-1 ring-transparent",
                "*:data-icon:text-on-primary/80 hover:*:data-icon:text-on-primary",
            ].join(" "),
        },
        secondary: {
            root: [
                "bg-surface-container-low text-on-surface shadow-sm ring-1 ring-outline-variant/30 ring-inset hover:bg-surface-container data-loading:bg-surface-container",
                "*:data-icon:text-on-surface-variant hover:*:data-icon:text-on-surface",
            ].join(" "),
        },
        tertiary: {
            root: [
                "text-on-surface-variant hover:bg-surface-container-low hover:text-on-surface data-loading:bg-surface-container-low",
                "*:data-icon:text-on-surface-variant hover:*:data-icon:text-on-surface",
            ].join(" "),
        },
        "link-color": {
